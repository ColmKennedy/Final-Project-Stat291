...
author: "Colm Kennedy, Shril Patel, Ethan Matta"
date: "2022-11-03"
output:
...
ggplot(data = all, mapping = aes(x = log(chdperwoman))) +
  geom_histogram(color = 'white') +
  scale_x_continuous(labels = scales::comma)
...
ggplot(data = all, mapping = aes(x = log(chdperwoman), y = lifeexp)) + 
  geom_point()+
  geom_smooth(method = 'lm', se = FALSE)
...
ggplot(data = all, mapping = aes(x = log(co2))) +
  geom_histogram(color = 'white') +
  scale_x_continuous(labels = scales::comma)

ggplot(data = all, mapping = aes(x = co2^2)) +
  geom_histogram(color = 'white') +
  scale_x_continuous(labels = scales::comma)
